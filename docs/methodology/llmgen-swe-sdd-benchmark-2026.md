...
| **3rd-party fork management** | 3 projects (unvendored open-source forks) | Managed via brownfield analysis + addons |
...
| **3rd-party fork management** | Yes (unvendored OSS forks) | No | No | No | No |
...
| **3rd-party fork** | Unvendored open-source project (no vendor support) managed via LLMGen brownfield analysis + addon workflow |
